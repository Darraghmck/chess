...
public class ChessProject extends JFrame implements MouseListener, MouseMotionListener {
    ...
    public int Value(int x, int y, int oldx, int oldy){
      int value = 0;
...
validM = new Move(startingSquare, tmp4, Value(((tmp4.getXC()*75)+20), ((tmp4.getYC()*75)+20),x,y));
  if((!piecePresent(((tmp4.getXC()*75)+20), ((tmp4.getYC()*75)+20)))){
    moves.push(validM);
  }

}
//this line is for stopping the piece moving off the board after its first move
if((tmpx1 <= 7 || tmpx2 >= 0)&&(tmpy1 <= 7)){
      validM2 = new Move(startingSquare, tmp, Value(((tmp.getXC()*75)+20), ((tmp.getYC()*75)+20),x,y) );//can only move in this direction if a piece can be taken
      if(checkWhiteOponent(((tmp.getXC()*75)+20), (((tmp.getYC()*75)+20)))){
        moves.push(validM2);
      }
      validM3 = new Move(startingSquare, tmp2,Value(((tmp2.getXC()*75)+20), ((tmp2.getYC()*75)+20),x,y));//can only move in this direction if a piece can be taken
      if(checkWhiteOponent(((tmp2.getXC()*75)+20), (((tmp2.getYC()*75)+20)))){
        moves.push(validM3);
      }
      validM4 = new Move(startingSquare, tmp3, Value(((tmp3.getXC()*75)+20), ((tmp3.getYC()*75)+20),x,y));// regular move no need to check for opponent
...
*/
  if(!((tmpx1 > 7))){
    ...
    */
    ...
    if(checkSurroundingSquares(tmp)){
      validM = new Move(startingSquare, tmp, Value(((tmp.getXC()*75)+20), ((tmp.getYC()*75)+20),x,y));
    ...
    if(!(tmpy1 > 7)){
      if(checkSurroundingSquares(tmp1)){
        validM2 = new Move(startingSquare, tmp1, Value(((tmp1.getXC()*75)+20), ((tmp1.getYC()*75)+20),x,y));
    ...
    if(!(tmpy2 < 0)){
      if(checkSurroundingSquares(tmp2)){
        validM3 = new Move(startingSquare, tmp2, Value(((tmp2.getXC()*75)+20), ((tmp2.getYC()*75)+20),x,y));
  ...
  if(!((tmpx2 < 0))){
    ...
    if(checkSurroundingSquares(tmp3)){
      validM = new Move(startingSquare, tmp3, Value(((tmp3.getXC()*75)+20), ((tmp3.getYC()*75)+20),x,y));
      if(!piecePresent(((tmp3.getXC()*75)+20), (((tmp3.getYC()*75)+20)))){
        moves.push(validM);
      }
      else{
    ...
    if(!(tmpy1 > 7)){
      if(checkSurroundingSquares(tmp4)){
        validM2 = new Move(startingSquare, tmp4, Value(((tmp4.getXC()*75)+20), ((tmp4.getYC()*75)+20),x,y));
        if(!piecePresent(((tmp4.getXC()*75)+20), (((tmp4.getYC()*75)+20)))){
          moves.push(validM2);
        }
        else{
    ...
    if(!(tmpy2 < 0)){
      if(checkSurroundingSquares(tmp5)){
        validM3 = new Move(startingSquare, tmp5, Value(((tmp5.getXC()*75)+20), ((tmp5.getYC()*75)+20),x,y));
  ...
  if(!(tmpy1 > 7)){
    if(checkSurroundingSquares(tmp7)){
      validM2 = new Move(startingSquare, tmp7, Value(((tmp7.getXC()*75)+20), ((tmp7.getYC()*75)+20),x,y));
  ...
  if(!(tmpy2 < 0)){
    if(checkSurroundingSquares(tmp8)){
      validM3 = new Move(startingSquare, tmp8, Value(((tmp8.getXC()*75)+20), ((tmp8.getYC()*75)+20),x,y));
  ...
  */
  ...
  for(int j=1;j < 8;j++){
    ...
    if(!(tmpx1 > 7 || tmpx1 < 0)){
      ...
      validM2 = new Move(startingSquare, tmp2,Value(((tmp2.getXC()*75)+20), ((tmp2.getYC()*75)+20),x,y));
      if(!piecePresent(((tmp2.getXC()*75)+20), (((tmp2.getYC()*75)+20)))){
        moves.push(validM2);
      }
      else{
  ...
  for(int k=1;k < 8;k++){
    ...
    if(!(tmpy3 > 7 || tmpy3 < 0)){
      ...
      validM3 = new Move(startingSquare, tmp3,Value(((tmp3.getXC()*75)+20), ((tmp3.getYC()*75)+20),x,y));
      if(!piecePresent(((tmp3.getXC()*75)+20), (((tmp3.getYC()*75)+20)))){
        moves.push(validM3);
      }
      else{
  ...
  for(int l=1;l < 8;l++){
    ...
    if(!(tmpy4 > 7 || tmpy4 < 0)){
      ...
      validM4 = new Move(startingSquare, tmp4,Value(((tmp4.getXC()*75)+20), ((tmp4.getYC()*75)+20),x,y));
      if(!piecePresent(((tmp4.getXC()*75)+20), (((tmp4.getYC()*75)+20)))){
        moves.push(validM4);
      }
      else{
  ...
  */
  ...
  for(int k=1;k < 8;k++){
    ...
    if(!(tmpk > 7 || tmpk < 0 || tmpy2 > 7 || tmpy2 < 0)){
      ...
      validM2 = new Move(startingSquare, tmpK1,Value(((tmpK1.getXC()*75)+20), ((tmpK1.getYC()*75)+20),x,y));
  ...
  for(int l=1;l < 8;l++){
    ...
    if(!(tmpL2 > 7 || tmpL2 < 0 || tmpy3 > 7 || tmpy3 < 0)){
      ...
      validM3 = new Move(startingSquare, tmpLMov2,Value(((tmpLMov2.getXC()*75)+20), ((tmpLMov2.getYC()*75)+20),x,y));
  ...
  for(int n=1;n < 8;n++){
    ...
    if(!(tmpN2 > 7 || tmpN2 < 0 || tmpy4 > 7 || tmpy4 < 0)){
      ...
      validM4 = new Move(startingSquare, tmpNmov2,Value(((tmpNmov2.getXC()*75)+20), ((tmpNmov2.getYC()*75)+20),x,y));
...
private Stack getKnightMoves(int x, int y, String piece){
  ...
  for(int i=0;i < 8;i++){
    ...
    Move tmpmove = new Move(startingSquare, tmp,Value(((tmp.getXC()*75)+20), ((tmp.getYC()*75)+20),x,y));
...
private void makeAIMove(){
  ...
  */
  ...
  Stack completeMoves = new Stack();
  Stack completeBMoves = new Stack();
  Move tmp;
  // Move tmpB;
  // while(!black.empty()){
  //   Square s = (Square)black.pop();
  //   String tmpBString = s.getName();
  //   Stack tmpBMoves = new Stack();
  //   Stack temporary = new Stack();
  //   /*
  //       We need to identify all the possible moves that can be made by the AI Opponent
  //   */
  //   if(tmpBString.contains("Knight")){
  //     tmpBMoves = getKnightMoves(s.getXC(), s.getYC(), s.getName());
  //   }
  //   else if(tmpBString.contains("Bishop")){
  //    tmpBMoves = getBishopMoves(s.getXC(), s.getYC(), s.getName());
  //   }
  //   else if(tmpBString.contains("Pawn")){
  //   tmpBMoves = getWhitePawnSquares(s.getXC(), s.getYC(), s.getName());
  //   }
  //   else if(tmpBString.contains("Rook")){
  //    tmpBMoves = getRookMoves(s.getXC(), s.getYC(), s.getName());
  //   }
  //   else if(tmpBString.contains("Queen")){
  //    tmpBMoves = getQueenMoves(s.getXC(), s.getYC(), s.getName());
  //   }
  //   else if(tmpBString.contains("King")){
  //     tmpBMoves = getKingSquares(s.getXC(), s.getYC(), s.getName());
  //   }
  //
  //   while(!tmpBMoves.empty()){
  //     tmpB = (Move)tmpBMoves.pop();
  //     completeBMoves.push(tmpB);
  //   }
  // }
  while(!white.empty()){
...
System.exit(0);
  ...
  */
  // System.out.println("=============================================================");
  // Stack testingB = new Stack();
  // while(!completeBMoves.empty()){
  //   Move tmpBMoves = (Move)completeBMoves.pop();
  //   Square s1B = (Square)tmpBMoves.getStart();
  //   Square s2B = (Square)tmpBMoves.getLanding();
  //   int thisValueB = (int)tmpBMoves.getPoints();
  //   System.out.println("The "+s1B.getName()+" can move from ("+s1B.getXC()+", "+s1B.getYC()+") to the following square: ("+s2B.getXC()+", "+s2B.getYC()+")"+thisValueB);
  //   testingB.push(tmpBMoves);
  // }
    System.out.println("=============================================================");
    ...
    while(!completeMoves.empty()){
     ...
     System.out.println("=============================================================");
     rand = new Random();
     int moveID = rand.nextInt(testing.size());
     Border redBorder = BorderFactory.createLineBorder(Color.RED, 3);
     Move selectedMove = agent.AgentPicked(selection, testing , black, moveID);
  ...
  private Boolean pieceMove(int x, int y){
	...
	*/
    public void mouseReleased(MouseEvent e) {
        ...
        else if(pieceName.contains("Bishop")||pieceName.contains("Knight")){
          value1 = 3;
        }
        ...
        System.out.println("the value of this piece is "+value1); //gives the value of the selected piece 
        System.out.println("----------------------------------------------");
